...
def create_app() -> Flask:
    ...
    def validate():
        ...
        logger.info("Validating — instruction: %d chars, file: %s, note: %d chars",
                    len(user_instruction or ""), filename, len(file_content or ""))
        ...
        forward_result = forward_to_prompt_rewriter(filename, file_content, instruction_id)
    ...
    def health():
        return jsonify({"status": "healthy", "service": "icd10-user-instruction-parser"}), 200
